 ...
 */
//package homepack;
public class Paymentfx2 extends javax.swing.JFrame {
	int p;
	int choice=-1;
    /**
     * Creates new form Payment
     */
    public Paymentfx2(int p1) {
		this.p=p1;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        dispose(); 	
       homepagefx h=new homepagefx(this.p);// TODO add your handling code here:
    }                                        
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
		...
		{
			Construction cs=new Construction(this.p);//call under construction block.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Paymentfx2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Paymentfx2(-1).setVisible(true);
            }
        });
    }
