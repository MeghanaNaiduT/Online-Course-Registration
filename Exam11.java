...
// package exampack;
public class Exam11 extends javax.swing.JFrame {

    /**
     * Creates new form Exam11
     */
	 int  mk1=0;
	 int z;
    public Exam11(int m) {
    ...
    private void initComponents() {
        ...
        jRadioButton5.setText("0.1, 2, 31, 1");
        ...
        jRadioButton6.setText("2.1, 2, 31, 1");
        ...
        jRadioButton7.setText("2, 2.1, 31, 1");
        ...
        jTextArea3.setText("def Recur_facto(n, a=1):\nif(n==0)\nreturn a\nreturn Recur_facto(n-1, n*a)\nprint(Recur_facto(6))");
        ...
        jTextArea4.setText("text = 'Mini Project'\nprint(text.swapCase())");
        jScrollPane4.setViewportView(jTextArea4);

        buttonGroup4.add(jRadioButton16);
        jRadioButton16.setText("mINI pROJECT");
        ...
        jRadioButton14.setText("MINI PROJECT");
        ...
        jRadioButton13.setText("None of the above");
        ...
        jRadioButton17.setText("(1,2,3),(3,2,1,0),(2)");
        ...
        jRadioButton19.setText("(1,2,3),(3,2,1,0),(3,2)");
        ...
        jRadioButton18.setText("(1,2,3),(3,2,1,0),(2,3)");
        ...
        jTextArea5.setText("turple1 = (0, 1, 2, 3)\nprint(turple1[1:])\nprint(turple1[::-1])\nprint(turple1[2:4])");
        jScrollPane5.setViewportView(jTextArea5);

        buttonGroup5.add(jRadioButton20);
        jRadioButton20.setText("(1,2,3),(3,2,1),(2,3)");
    ...
    private void jRadioButton6ActionPerformed(java.awt.event.ActionEvent evt) {                                              
        this.mk1++;// TODO add your handling code here:
    }                                             
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {     
		dispose(); 	
		try{
       Exam_Marks exm=new Exam_Marks(this.mk1,1,this.z); 
	   UG11_Pythonfx upy=new UG11_Pythonfx(this.z);// TODO add your handling code here:
		}
		catch(Exception e)
		{
			System.out.println("Exception in Exam11");
			e.printStackTrace();
		}
    }                                        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Exam11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new Exam11(this.z).setVisible(true);
            }
        });
		Exam11 e1=new Exam11(1);
    }
